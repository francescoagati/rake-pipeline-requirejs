...
(function() {
  ...
  (function() {
    var define = cloakContext.makeDefineFunction('backbone');
  ...
  (function() {
    var define = cloakContext.makeDefineFunction('jquery-src');
    define(function() {
  ...
  (function() {
    var define = cloakContext.makeDefineFunction('jquery');
  ...
  (function() {
    var define = cloakContext.makeDefineFunction('main');
  ...
  (function() {
    var define = cloakContext.makeDefineFunction('underscore');
    define(function() {
      return 'underscore';
    });
